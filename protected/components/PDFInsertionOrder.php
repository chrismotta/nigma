...
3.7 If Media Company and/or Agency utilizes an electronic signature (“E-Signature”), it agrees that its E-Signature is the legal equivalent of its manual signature on all contracts and shall be construed as an acceptance of the terms.  In the event that an E-Signature does not result in a signature, any automated mechanism that is used by the Media Company in order to confirm the acceptance of a contract, Insertion Order, or any amendment will be the legal equivalent of an original signature and will be construed as an acceptance of the terms.  Media Company also agrees that no certification authority is necessary to validate its E-Signature and that the lack of such certification or third party verification will not in any way affect the enforceability of its E-Signature or any resulting contract between Agency and Media Company.  Media Company further agrees that each use of its E-Signature constitutes its agreement to be bound by the terms and conditions of the Insertion Orders as they exist on the date of the E-Signature.
