...
class WURFL_Request_UserAgentNormalizer_Specific_UcwebU2 implements WURFL_Request_UserAgentNormalizer_Interface
{
    public function normalize($userAgent)
    {
        ...
        //iPhone U2K
        elseif (WURFL_Handlers_Utils::checkIfContains($userAgent, 'iPh OS')) {
        ...
        //Symbian U2K
        elseif (WURFL_Handlers_Utils::checkIfContains($userAgent, 'Symbian')) {
        ...
        elseif (WURFL_Handlers_Utils::checkIfContains($userAgent, 'Java')) {
