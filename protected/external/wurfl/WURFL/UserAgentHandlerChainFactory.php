...
class WURFL_UserAgentHandlerChainFactory
{
    ...
    private static function init(WURFL_Context $context)
    {
        ...
        $genericNormalizers = new WURFL_Request_UserAgentNormalizer();
        
        /**** Smart TVs ****/
        self::$_userAgentHandlerChain->addUserAgentHandler(new WURFL_Handlers_SmartTVHandler($context, $genericNormalizers));
        
        /**** Mobile devices ****/
        self::$_userAgentHandlerChain->addUserAgentHandler(new WURFL_Handlers_KindleHandler($context, $genericNormalizers));
        ...
        $operaMiniNormalizer = $genericNormalizers->addUserAgentNormalizer(new WURFL_Request_UserAgentNormalizer_Specific_OperaMini());
        self::$_userAgentHandlerChain->addUserAgentHandler(new WURFL_Handlers_OperaMiniHandler($context, $operaMiniNormalizer));
        ...
        self::$_userAgentHandlerChain->addUserAgentHandler(new WURFL_Handlers_KonquerorHandler($context, $genericNormalizers));
    ...
    public static function createGenericNormalizers()
    {
        return new WURFL_Request_UserAgentNormalizer(array(
            new WURFL_Request_UserAgentNormalizer_Generic_IISLogging(),
