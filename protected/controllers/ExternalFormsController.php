		...
		if($ios->save())
		{
			...
			$body = '
							<span style="color:#000">
							  ...
							  <p><a href="http://kickadserver.mobi/externalForms/revenueValidation/'.$model->validation_token.'">http://kickadserver.mobi/externalForms/revenueValidation/'.$model->validation_token.'</a></p>
