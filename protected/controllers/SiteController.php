...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$this->render('index',array(
			'dataTopConversions'     =>$model->cache(3600)->getTops($startDate,$endDate,'conversions'),
			'dataTopConversionsRate' =>$model->cache(3600)->getTops($startDate,$endDate,'convrate'),
			'dataTops'               =>$model->cache(3600)->getTops($startDate,$endDate,'spend'),
			'dataTopProfit'          =>$model->cache(3600)->getTops($startDate,$endDate,'profit'),
			'dataHighchart'          =>$totals->cache(3600)->getTotals($startDate,$endDate),
		));
	}
