...
/**
 * This is the model class for table "revenue_validation".
 *
 * The followings are the available columns in table 'revenue_validation':
 * @property integer $id
 ...
 * @property Ios $ios
 */
class RevenueValidation extends CActiveRecord
{
	/**
	 ...
	 * @return RevenueValidation the static model class
	 */
