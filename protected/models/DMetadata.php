...
/**
 * This is the model class for table "D_Metadata".
 *
 * The followings are the available columns in table 'D_Metadata':
 * @property integer $id
 ...
 */
class DMetadata extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, pubid, ip_forwarded, referer_url, referer_app', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fImpressions' => array(self::HAS_MANY, 'FImpressions', 'D_Metadata_id'),
		);
	}
	 ...
	 * @return DMetadata the static model class
	 */
