...
<?php
	...
	$g_date      = 0;//isset($_GET['g_date']) ? $_GET['g_date'] : 1;
	$g_placement = 0;//isset($_GET['g_placement']) ? $_GET['g_placement'] : 1;
	$g_country   = 0;//isset($_GET['g_country']) ? $_GET['g_country'] : 1;
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
		...
		'action'               => Yii::app()->controller->createUrl(Yii::app()->controller->id . '/' .Yii::app()->controller->action->id . '/' . $hash),
		'method'               => 'GET',
