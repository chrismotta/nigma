...
<?php 
    ...
    $items=array(
        ...
        array(
            ...
            'items'=>array(
                ...
                array('label'=>'Campaigns', 'url'=>array('/campaigns/admin'),
                    'visible' => rol('admin') || rol('account_manager') || rol('account_manager_admin') || rol('media_buyer_admin') || rol('operation_manager'),
                    ),
                array('label'=>'Tags', 'url'=>array('/tags/admin'),
                    'visible' => rol('admin') || rol('media_buyer_admin') || rol('operation_manager'),
                    ),
                array('label'=>'Tags Reporting', 'url'=>array('/stats/impressions'),
                    'visible' => rol('admin') || rol('media_buyer_admin') || rol('operation_manager'),
                    ),
                array('label'=>'Traffic Log', 'url'=>array('/campaigns/traffic'),
                    'visible' => rol('admin') || rol('account_manager') || rol('account_manager_admin') || rol('operation_manager'),
                    ),
                array('label'=>'Click Log Report', 'url'=>array('/clicklog/admin'),
                    'visible' => rol('admin') || rol('account_manager') || rol('account_manager_admin') || rol('operation_manager'),
                    ),
        ...
        ), 'visible' => rol('admin') || rol('sem') || rol('account_manager_admin'),
        ),
        array(
            'label'=>'Finance', 
            'url'=>'#',
            ...
            'items'=>array(
                array('label'=>'Clients', 'url'=>array('/finance/clients'),
                    'visible' => rol('admin') || rol('finance') || rol('account_manager_admin') || rol('operation_manager'),
                    ),
